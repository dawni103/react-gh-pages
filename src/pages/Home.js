                ...
                <div class="col-md-6 ab-content ab-content1">
                    <div class="ab-content-inner">
                        ...
                        <div class="ab-info-con">
                            ...
                            <Link to="/single" class="read-more two btn m-0 px-3"><span class="fa fa-arrow-circle-o-right"> </span></Link>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 ab-content ab-content1">
        ...
        <div class="container py-md-5">
            <div class="test-info text-center">
                ...
                <div class="read-more mx-auto m-0 text-center">
                    <Link to="/contact" class="read-more scroll btn">Click here</Link> </div>
            </div>
        </div>
    </section>
    {/* <!--//order-now--> */}
